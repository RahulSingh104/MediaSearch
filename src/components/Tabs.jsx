...
//             return (
//                 <button className={`${(activeTab==elem?'bg-amber-600':'bg-gray-600')}  transition bg-gray-600 cursor-pointer active:scale-95 px-5 py-2 rounded uppercase`} key={idx} onClick={()=>{
